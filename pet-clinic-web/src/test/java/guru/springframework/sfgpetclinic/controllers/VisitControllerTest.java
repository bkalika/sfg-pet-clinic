...
public class VisitControllerTest {
    ...
    private final UriTemplate visitsTemplate = new UriTemplate("/owners/{ownerId}/pets/{petId}/visits/new");
    ...
    void setup() {
        ...
        when(petService.findById(anyLong()))
                .thenReturn(Pet.builder()
                        .id(petId)
                        .birthDate(LocalDate.of(2024, 04, 15))
                        .name("Cutie")
                        .visits(new HashSet<>())
                        .owner(Owner.builder()
                                .id(ownerId)
        ...
        visitsUri = visitsTemplate.expand(uriVariables);
